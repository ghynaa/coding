...
const certificates = [
  ...
  {
    title: 'Finalist Medal',
    issuer: 'ASEAN ENGLISH LITERACY COMPETITION',
    date: '2024',
  ...
  {
    title: 'Peserta',
    issuer: 'Olimpiade Sains PGRI ACEH',
    date: '2023',
  ...
  {
    title: 'Peraih Medali Perunggu',
    issuer: 'KOMPETISI SAINS PELAJAR SE-INDONESIA',
    date: '2024',
